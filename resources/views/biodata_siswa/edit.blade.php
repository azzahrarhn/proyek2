                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="formSiswa" action="{{ route('biodata_siswa.update', $siswa->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="nisn" class="form-control"
                                                placeholder="Masukkan NISN siswa" name="nisn" value="{{ $siswa->nisn }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="date" id="tanggalLahir" class="form-control"
                                                name="tanggal_lahir" value="{{ $siswa->tanggal_lahir }}" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select id="agama" class="form-select" name="agama" required>
                                                ...
                                                <option value="Katolik"
                                                    {{ $siswa->agama == 'Katolik' ? 'selected' : '' }}>Katolik</option>
                                                <option value="Hindu" {{ $siswa->agama == 'Hindu' ? 'selected' : '' }}>
                                                    Hindu</option>
                                                <option value="Buddha"
                                                    {{ $siswa->agama == 'Buddha' ? 'selected' : '' }}>Buddha</option>
                                                <option value="Konghucu"
                                                    {{ $siswa->agama == 'Konghucu' ? 'selected' : '' }}>Konghucu
                                                </option>
                                            </select>
                                        </div>
                                    </div>
