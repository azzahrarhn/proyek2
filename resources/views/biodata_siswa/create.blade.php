            ...
            <section class="section">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Form Tambah/Simpan Data Siswa</h5>
                                <form id="formSiswa" action="{{ route('biodata_siswa.store') }}" method="POST">
                                    @csrf
                                    <div class="row mb-3">
                                        <label for="nama" class="col-sm-2 col-form-label">Nama Lengkap</label>
                                        <div class="col-sm-10">
                                            <input type="text" id="nama" class="form-control"
                                                placeholder="Masukkan nama lengkap siswa" name="nama_siswa" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="nisn" class="form-control"
                                                placeholder="Masukkan NISN siswa" name="nisn" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select id="jenisKelamin" class="form-select" name="jenis_kelamin" required>
                                    ...
                                    <div class="row mb-3">
                                        <label for="tempatTanggalLahir" class="col-sm-2 col-form-label">Tempat Tanggal
                                            Lahir</label>
                                        <div class="col-sm-5">
                                    ...
                                    <div class="row mb-3">
                                        <label for="alamat" class="col-sm-2 col-form-label">Alamat Peserta Didik</label>
                                        <div class="col-sm-10">
                                            <textarea id="alamat" class="form-control"
                                                placeholder="Masukkan alamat siswa" style="height: 80px" name="alamat"
                                                required></textarea>
                                        </div>
                                    </div>

                                    <!-- Biodata Orang Tua -->
                                    <h5 class="mt-4">Biodata Orang Tua</h5>
                                    <div class="row mb-3">
                                        <label for="namaAyah" class="col-sm-2 col-form-label">Nama Ayah</label>
                                        <div class="col-sm-10">
                                            <input type="text" id="namaAyah" class="form-control"
                                                placeholder="Masukkan nama ayah" name="nama_ayah" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="pekerjaanAyah" class="col-sm-2 col-form-label">Pekerjaan
                                            Ayah</label>
                                        <div class="col-sm-10">
                                            <input type="text" id="pekerjaanAyah" class="form-control"
                                                placeholder="Masukkan pekerjaan ayah" name="pekerjaan_ayah" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="pekerjaanIbu" class="form-control"
                                                placeholder="Masukkan pekerjaan ibu" name="pekerjaan_ibu" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
